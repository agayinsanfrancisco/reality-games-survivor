 ...
 */
router.post('/lock-picks', async (req, res) => {
    try {
 ...
 */
router.post('/unlock-picks', async (req, res) => {
    try {
 ...
 */
router.post('/pause-drafts', async (req, res) => {
    try {
 ...
 */
router.post('/resume-drafts', async (req, res) => {
    try {
        const adminId = req.user.id;
        const now = DateTime.now().setZone('America/Los_Angeles');
        // Get paused drafts
 ...
 */
router.post('/emergency-shutoff', async (req, res) => {
    try {
