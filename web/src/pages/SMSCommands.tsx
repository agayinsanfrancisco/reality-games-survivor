  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-cream-100 to-cream-200">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-neutral-600">
              Go to your <Link to="/profile" className="text-burgundy-500 hover:text-burgundy-600 font-medium">Profile</Link> and add your phone number.
            </p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-6 h-6 bg-burgundy-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="bg-white rounded-2xl shadow-card p-6 border border-cream-200">
        <h2 className="text-lg font-display font-bold text-neutral-800 mb-4">Available Commands</h2>
          ...
          {commands.map((cmd) => (
            <div key={cmd.command} className="bg-cream-50 rounded-xl p-4 border border-cream-200">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <code className="text-neutral-800 bg-cream-100 px-2 py-1 rounded">{cmd.example}</code>
              </div>
            </div>
          ))}
        </div>
