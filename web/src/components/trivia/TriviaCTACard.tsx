/**
 * Trivia CTA Card Component
 *
 * Call to action to join a league.
 */

import { Link } from 'react-router-dom';
import { Trophy } from 'lucide-react';

export function TriviaCTACard() {
  return (
    <div className="mt-8 bg-gradient-to-r from-burgundy-500 to-red-600 rounded-2xl p-8 text-white text-center shadow-lg">
      <Trophy className="h-12 w-12 mx-auto mb-4" />
      <h3 className="text-2xl font-display font-bold mb-2">Ready to Play for Real?</h3>
      <p className="text-burgundy-100 mb-6 max-w-lg mx-auto">
        Join Season 50 and compete in fantasy leagues. Draft castaways, make weekly picks, and prove
        you're the ultimate Survivor fan!
      </p>
      <Link
        to="/dashboard"
