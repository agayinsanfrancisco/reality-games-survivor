...
import { Trophy, ChevronRight, Crown, Medal, Users } from 'lucide-react';
...
export function TopPerformersCard({
  ...
  // Sort members by points for proper ranking
    ...
    <div className="bg-white rounded-2xl shadow-card p-5 border border-cream-200">
      ...
      {(!members || members.length === 0) && (
        <div className="text-center py-6">
          ...
          <p className="text-neutral-500 text-sm">No standings yet</p>
        </div>
      )}
